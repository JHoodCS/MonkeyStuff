...
%   fixed. External control inputs are stubbed for future integration.
    ...
    % Slide title label centred at the top of the figure, rendered as a
    % uicontrol so it always appears above the panels and 3D scene
    titleLabel = uicontrol(fig, ...
        'Style', 'text', ...
        'String', '', ...
        'Units', 'normalized', ...
        'Position', [0.25 0.955 0.48 0.03], ...
        'FontSize', 15, ...
        'FontWeight', 'bold', ...
